  ...
  return(<div style={{minHeight:'100vh',background:T.bg,color:T.ink}}>
    ...
    <header style={{position:'sticky',top:0,zIndex:40,background:T.glass,backdropFilter:'blur(10px)',borderBottom:`1px solid ${T.line}`}}>
      <div style={{maxWidth:1600,margin:'0 auto',padding:'0 24px',height:58,display:'flex',alignItems:'center',gap:14}}>
        <div className="ed-brand" onClick={()=>go('highlights')} style={{display:'flex',alignItems:'center',gap:9,cursor:'pointer',flexShrink:0}}><span style={{width:28,height:28,borderRadius:7,background:T.invBg,color:T.invFg,display:'flex',alignItems:'center',justifyContent:'center',fontWeight:700,fontSize:13,flexShrink:0}}>H</span><span className="ed-brandtext" style={{fontWeight:700,whiteSpace:'nowrap'}}>The Hockey Lab</span></div>
        <button className="ed-homebtn" onClick={()=>go('highlights')} title="Lab home" aria-label="Lab home" style={{color:T.faint,fontSize:17,background:'none',border:'none',cursor:'pointer',padding:0,fontFamily:'inherit',lineHeight:1,flexShrink:0}}>⌂</button>
