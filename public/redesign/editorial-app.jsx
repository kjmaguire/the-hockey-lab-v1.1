    ...
    <div style={{...card,overflow:'hidden'}}>
      ...
      <div style={{padding:'16px'}}>
        <div style={{display:'flex',alignItems:'center',gap:13,marginBottom:16,flexWrap:'wrap'}}>
          ...
          <span style={{marginLeft:'auto',display:'inline-flex',alignItems:'center',gap:7,fontFamily:MONO,fontSize:11,letterSpacing:'.05em',textTransform:'uppercase',padding:'6px 11px',borderRadius:999,background:fSel.onIce?'#eaf6ef':T.bg,color:fSel.onIce?'#1a8a4f':T.faint,border:`1px solid ${fSel.onIce?'#bfe3cd':T.line2}`}}>{fSel.onIce&&<span className="ed-pulse" style={{width:6,height:6,borderRadius:99,background:'#1a8a4f',display:'inline-block'}}/>}{fSel.isG?'In net':fSel.onIce?`On ice · ${fmtTOI(fSel.shiftSec)}`:'On bench'}</span>
        </div>
